...
public class StringStretcher {
	...
	public String padL(int text, int length) {
		return stretch(String.valueOf(text), length, ' ', 'L');
	}
	public String padL(String text, int length) {
		return stretch(text, length, ' ', 'L');
	}

	public String padL(String text, int length, char padWith) {
		return stretch(text, length, padWith, 'L');
	}

	public String padC(String text, int length) {
		return stretch(text, length, ' ', 'C');
	}

	public String padC(String text, int length, char padWith) {
		return stretch(text, length, padWith, 'C');
	}

	public String padR(String text, int length) {
		return stretch(text, length, ' ', 'R');
	}

	public String padR(String text, int length, char padWith) {
		return stretch(text, length, padWith, 'R');
	}
}
